  ...
  return (
    <div className="flex    ">
      <div className="w-1/5 h-min-scheen bg-red-400">
          ...
          {userInfo?.role=='employee'&&<li className="hover:bg-gray-300 p-2 rounded-xl " ><NavLink to='/' className=' ml-2'>My Team</NavLink></li>}
          ...
          {<li className="hover:bg-gray-300 p-2 rounded-xl "><NavLink to='/' className=' ml-2'>Profile</NavLink></li>}
          {<li className="hover:bg-gray-300 p-2 rounded-xl "><NavLink to='/' className=' ml-2'>Logout</NavLink></li>}
          </div>
      </div>
